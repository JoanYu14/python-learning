...
class Car():
    ...
    def __init__(self,input_name,input_brand): # self指的是自己()
        self.name = input_name # 這個物件的name attribute為init函數中的input_name參數的值
        self.brand = input_brand # 這個物件的brandattribute為init函數中的input_brand參數的值
...
print(f"car1的車名為:{car1.name}，品牌為:{car1.brand}") # car1的車名為:XC90，品牌為:volvo
print(f"car1的class的描述為:{car1.__doc__}") # Car class的描述為:Car class是用於製作Car物件
